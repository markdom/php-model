# Contributing to PHP Markdom Model
...
Here’s an example workflow for `php-model` hosted on Github, which is currently in version 1.0.2. Your username is `yourname` and you’re submitting a basic bugfix. 

### Preparing your Fork

- Hit ‘fork’ on Github, creating e.g. `yourname/php-model`
- Clone your project  

```
git clone git@git.markenwerk.net:yourname/php-model.git
```
